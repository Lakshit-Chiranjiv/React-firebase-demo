...
const DbInterface = ({presentUsername}) => {
  ...
  return (
    ...
    <h1 className='text-center m-3 display-1'>Firebase Restaurent</h1>
    {
        ...
        <>
            {
                presentUsername &&
                <h1 className='text-center m-3 display-4'>Hello, {presentUsername}</h1>
            }
            <div className='mb-5 db'>
                ...
                <div className="add">
                    ...
                    <form className='me-3 border-bottom border-2' onSubmit={submitMenuItem}>
            ...
            <div className="d-flex justify-content-center w-100">
                <button className='btn btn-danger w-25 m-4' onClick={logoutUser}>Logout</button>
            </div>
        </>
    }
    {
        ...
        <div className="d-flex flex-column align-items-center">
            <h2 className='text-center'>Please Login or Register !!</h2>
